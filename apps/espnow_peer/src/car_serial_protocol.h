...
#define CAR_SERIAL_VERSION 3U
#define CAR_SERIAL_HEADER_SIZE 7U
#define CAR_SERIAL_CRC_SIZE 2U
#define CAR_SERIAL_MAX_PAYLOAD 70U
...
#define CAR_SERIAL_TYPE_PARAMETER 5U

#define CAR_SERIAL_COMMAND_PAYLOAD_SIZE 2U
#define CAR_SERIAL_IMU_PAYLOAD_SIZE 13U
#define CAR_SERIAL_TELEMETRY_PAYLOAD_SIZE 70U
#define CAR_SERIAL_ACK_PAYLOAD_SIZE 3U
#define CAR_SERIAL_PARAMETER_PAYLOAD_SIZE 5U
						 ...
						 uint8_t payload_size)
{
	...
	case CAR_SERIAL_TYPE_PARAMETER:
		return payload_size == CAR_SERIAL_PARAMETER_PAYLOAD_SIZE;
	default:
		return false;
	}
}
